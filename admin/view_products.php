                ...
                <tbody>
                    <?php
                        ...
                        while($row_fetch_products = mysqli_fetch_array($get_product_result)){
                            ...
                            $product_image_uno = $row_fetch_products['product_image_uno'];
                            $product_precio = $row_fetch_products['product_precio'];
                            ...
                            <td>$product_title</td>
                            <td>
                                <img src='./product_images/$product_image_uno' alt='$product_title' width='80px' class='img-thumbnail'/>
                            </td>
