            ...
            <div class="row py-5 m-0">
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    <table class="table table-bordered table-hover table-striped table-group-divider text-center">
                        ...
                        if ($result_count > 0) {
                            ...
                            while ($row = mysqli_fetch_array($cart_result)) {
                                ...
                                while ($row_product_price = mysqli_fetch_array($select_product_result)) {
                                    ...
                                    $price_table = $row_product_price['product_precio'];
                                    $product_id = $row_product_price['product_id'];
                                    $product_title = $row_product_price['product_title'];
                                    $product_image_uno = $row_product_price['product_image_uno'];
                        ...
                        ?>
                                    ...
                                    <tr class="d-flex flex-column d-md-table-row ">
                                        ...
                                        <td><img src="<?php echo $product_image_uno; ?>" class="img-thumbnail" alt="<?php echo $product_title; ?>"></td>
                                        <td>
                    ...
                    <div class="d-flex align-items-center gap-4 flex-wrap">
                        ...
                        <button class='btn btn-dark'><a class='text-light' href='./index.php'>Continuar Comprando</a></button>
                        
                        <button class='btn btn-dark'><a class='text-light' href='./users_area/checkout.php'>Checkout</a></button>
                        
                        ";
                        }else{
                            echo "<input type='button' value='Continuar Comprando' class='btn btn-dark' name='continue_shopping'>";
                        }
