                ...
                <div class="col-lg-6">
                    <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column gap-4">
                        ...
                        <div class="form-outline">
                            ...
                            <input type="email" placeholder="Ingresa tu email" autocomplete="off" required="required" name="user_email" id="user_email" class="form-control">
                        </div>
                        <!-- image field  -->
                        <div class="form-outline">
                        ...
                        <div class="form-outline">
                            <label for="conf_user_password" class="form-label">Confirmar Contraseña</label>
                            <input type="password" placeholder="Confirma tu contraseña" autocomplete="off" required="required" name="conf_user_password" id="conf_user_password" class="form-control">
                        </div>
                        <!-- address field  -->
                        <div class="form-outline">
                            <label for="user_address" class="form-label">Dirección</label>
                            <input type="text" placeholder="Ingresa tu dirección" autocomplete="off" required="required" name="user_address" id="user_address" class="form-control">
                        </div>
                        <!-- mobile field  -->
                        <div class="form-outline">
                            <label for="user_mobile" class="form-label">Móvil</label>
                            <input type="text" placeholder="Ingresa tu móvil" autocomplete="off" required="required" name="user_mobile" id="user_mobile" class="form-control">
                        </div>
                        <div>
                            <input type="submit" value="Registrar" class="btn btn-primary mb-2" name="user_register">
                            <p>
                                Ya tienes una cuenta? <a href="user_login.php" class="text-primary text-decoration-underline"><strong>Login</strong></a>
                            </p>
                        </div>
                    </form>
                </div>
...
if (isset($_POST['user_register'])) {
    ...
    if ($rows_count > 0) {
        echo "<script>window.alert('Usuario | Email ya existe');</script>";
        ...
        if ($insert_result) {
            echo "<script>window.alert('Usuario agregado exitosamente');</script>";
        } else {
